...
GX_TEXT_BUTTON_PROPERTIES window1_button_sel_properties =
{
    GX_STRING_ID_STRING_SEL,                 /* string id                      */
    GX_FONT_ID_BUTTON,                       /* font id                        */
    GX_COLOR_ID_BTN_TEXT,                    /* normal text color              */
    GX_COLOR_ID_BTN_TEXT,                    /* selected text color            */
    GX_COLOR_ID_DISABLED_TEXT                /* disabled text color            */
};
GX_PROMPT_PROPERTIES window1_prompt_sel_atual_properties =
{
    GX_STRING_ID_STRING_DESLIGADO,           /* string id                      */
    GX_FONT_ID_PROMPT,                       /* font id                        */
    GX_COLOR_ID_TEXT,                        /* normal text color              */
    GX_COLOR_ID_SELECTED_TEXT,               /* selected text color            */
    GX_COLOR_ID_DISABLED_TEXT                /* disabled text color            */
...
GX_NUMERIC_PROMPT_PROPERTIES window1_TEMP_MISTURA_properties =
{
    0,                                       /* string id                      */
    GX_FONT_ID_PROMPT,                       /* font id                        */
    GX_COLOR_ID_TEXT,                        /* normal text color              */
...
GX_NUMERIC_PROMPT_PROPERTIES window1_TEMP_MISTURA_DECIMAL_properties =
{
    0,                                       /* string id                      */
    GX_FONT_ID_PROMPT,                       /* font id                        */
    GX_COLOR_ID_TEXT,                        /* normal text color              */
...
GX_PROMPT_PROPERTIES window1_prompt_8_properties =
{
    GX_STRING_ID_STRING_29,                  /* string id                      */
    GX_FONT_ID_PROMPT,                       /* font id                        */
    GX_COLOR_ID_TEXT,                        /* normal text color              */
...
GX_CONST GX_STUDIO_WIDGET window1_prompt_8_define =
{
    "prompt_8",
    ...
    {197, 59, 216, 100},                     /* widget size                    */
    GX_NULL,                                 /* no next widget                 */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW1_CONTROL_BLOCK, window1_prompt_8), /* control block        */
    (void *) &window1_prompt_8_properties    /* extended properties            */
};
...
GX_CONST GX_STUDIO_WIDGET window1_prompt_7_define =
{
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {207, 151, 226, 192},                    /* widget size                    */
    &window1_prompt_8_define,                /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
...
GX_CONST GX_STUDIO_WIDGET window1_prompt_2_define =
{
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {205, 259, 224, 282},                    /* widget size                    */
    &window1_prompt_3_define,                /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
...
GX_CONST GX_STUDIO_WIDGET window1_TEMP_MISTURA_DECIMAL_define =
{
    "TEMP_MISTURA_DECIMAL",
    GX_TYPE_NUMERIC_PROMPT,                  /* widget type                    */
    ID_TEMP_MISTURA_DECIMAL,                 /* widget id                      */
    #if defined(GX_WIDGET_USER_DATA)
    0,                                       /* user data                      */
    #endif
    GX_STYLE_BORDER_THIN|GX_STYLE_TRANSPARENT|GX_STYLE_ENABLED|GX_STYLE_TEXT_CENTER,   /* style flags */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {183, 195, 202, 236},                    /* widget size                    */
    &window1_prompt_1_define,                /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW1_CONTROL_BLOCK, window1_TEMP_MISTURA_DECIMAL), /* control block */
    (void *) &window1_TEMP_MISTURA_DECIMAL_properties /* extended properties   */
};

GX_CONST GX_STUDIO_WIDGET window1_TEMP_MISTURA_define =
{
    "TEMP_MISTURA",
    GX_TYPE_NUMERIC_PROMPT,                  /* widget type                    */
    ID_TEMP_MISTURA,                         /* widget id                      */
    #if defined(GX_WIDGET_USER_DATA)
    0,                                       /* user data                      */
    #endif
    GX_STYLE_BORDER_THIN|GX_STYLE_TRANSPARENT|GX_STYLE_ENABLED|GX_STYLE_TEXT_CENTER,   /* style flags */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {120, 195, 169, 236},                    /* widget size                    */
    &window1_TEMP_MISTURA_DECIMAL_define,    /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW1_CONTROL_BLOCK, window1_TEMP_MISTURA), /* control block    */
    (void *) &window1_TEMP_MISTURA_properties /* extended properties           */
};
...
GX_CONST GX_STUDIO_WIDGET window1_prompt_define =
{
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {8, 195, 117, 236},                      /* widget size                    */
    &window1_TEMP_MISTURA_define,            /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW1_CONTROL_BLOCK, window1_prompt), /* control block          */
    (void *) &window1_prompt_properties      /* extended properties            */
};

GX_CONST GX_STUDIO_WIDGET window1_prompt_sel_atual_define =
{
    "prompt_sel_atual",
    GX_TYPE_PROMPT,                          /* widget type                    */
    id_prompt_sel_atual,                     /* widget id                      */
    #if defined(GX_WIDGET_USER_DATA)
    0,                                       /* user data                      */
    #endif
    GX_STYLE_BORDER_THIN|GX_STYLE_TRANSPARENT|GX_STYLE_ENABLED|GX_STYLE_TEXT_CENTER,   /* style flags */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {91, 17, 190, 58},                       /* widget size                    */
    &window1_prompt_define,                  /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW1_CONTROL_BLOCK, window1_prompt_sel_atual), /* control block */
    (void *) &window1_prompt_sel_atual_properties /* extended properties       */
};

GX_CONST GX_STUDIO_WIDGET window1_button_sel_define =
{
    "button_sel",
    GX_TYPE_TEXT_BUTTON,                     /* widget type                    */
    id_button_sel,                           /* widget id                      */
    #if defined(GX_WIDGET_USER_DATA)
    0,                                       /* user data                      */
    #endif
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {8, 17, 87, 58},                         /* widget size                    */
    &window1_prompt_sel_atual_define,        /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW1_CONTROL_BLOCK, window1_button_sel), /* control block      */
    (void *) &window1_button_sel_properties  /* extended properties            */
};
...
GX_CONST GX_STUDIO_WIDGET window1_temp_alvo_decimal_define =
{
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {175, 59, 194, 100},                     /* widget size                    */
    &window1_button_sel_define,              /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
