...
extern void Controle_valvula_create(void);
extern void Controle_saida_create(void);
extern void Controle_Vent_create(void);
...
void tx_application_define(void *first_unused_memory)
{
    ...
    lcd_thread_create ();
    Controle_valvula_create ();
    Controle_saida_create ();
    Controle_Vent_create ();
